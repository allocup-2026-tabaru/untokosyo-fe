...
export function RoomModal({
  ...
  return (
    ...
    >
      ...
      <section className="relative mt-4 flex w-full max-w-6xl flex-col overflow-hidden rounded-[2rem] border border-white/10 bg-black/52 text-white shadow-[0_30px_90px_rgba(0,0,0,0.35)] backdrop-blur-lg sm:mt-8 lg:max-h-[calc(100vh-4rem)]">
        ...
        <div className="grid gap-6 p-5 sm:p-7 lg:grid-cols-[1.1fr_1fr] lg:p-8">
          ...
          <div className="flex min-h-0 flex-col gap-5 lg:max-h-[calc(100vh-10rem)]">
            <div className="flex items-end justify-between gap-4">
              ...
              <p className="rounded-full bg-white/8 px-4 py-2 text-sm font-semibold text-white/78">
